...
@@ -36,82 +40,177 @@ def plotMulti(base,chunkSize,pinside):
         diz=eval(text)
...
def plotPerfectRun(filename,case,style):
    ...
    c=p.line(xp, yp1, line_width=3, line_dash="4 4", hover_line_color='red',hover_line_alpha=0.8)
...
actualdir='Evaluation/case3-150/'
